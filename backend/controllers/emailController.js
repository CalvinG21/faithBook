...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: process.env.emailSupportName,//'calvinsg777@gmail.com', // Replace with the admin's email
    pass: process.env.emailSupportPassword//'elah cchy mgkz isjd', // Replace with the admin's email password
  },
});
console.log("$$$ "+process.env.emailSupportName)
console.log("$$$ "+process.env.emailSupportPassword)
